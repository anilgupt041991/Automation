...
# Description:
#   Check whether REST API Gateway has a custom domain name and whether it matches the correct custom domain name.
#
# Rationale:
#   Regular checks for the correct custom domain name enables early detection of cybersquatting
#
# Indicative Severity:
#   High
#
# Trigger:
#   Configuration change on AWS::ApiGateway::DomainName
#
# Reports on:
...
# Rule Parameters:
#   CustomDomainName
#     (Optional) Specify your custom domain name to display COMPLIANT
#
# Scenarios:
#   Scenario: 1
#      Given: Rules parameter is provided
#        And: It contains a parameter key other than CustomDomainName
#       Then: Return ERROR
#   Scenario: 2
#      Given: Rules parameter is provided
#        And: Custom Domain Name of REST API GW matches the specified custom domain name in CustomDomainName
#       Then: Return COMPLIANT with annotation
#   Scenario: 3
#      Given: Rules parameter is provided
#        And: Custom Domain Name of REST API GW does not match the specified custom domain name in CustomDomainName
#       Then: Return NON_COMPLIANT with annotation
#   Scenario: 4
#      Given: REST API GW is active
#        And: REST API GW does not have a custom domain name
#       Then: Return NON_COMPLIANT with annotation
...
DEFAULT_RESOURCE_TYPE = 'AWS::ApiGateway::DomainName'
